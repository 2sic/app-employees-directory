...
namespace AppCode.Data
{
  ...
  /// Most properties have a simple access, such as `.AddContact`. <br/>
...
namespace AppCode.Data.AutoGenerated
{
  ...
  {
    /// <summary>
    /// AddContact as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("AddContact", scrubHtml: true) etc.
    /// </summary>
    public string AddContact => _item.String("AddContact", fallback: "");

    /// <summary>
    /// NoPerson as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("NoPerson", scrubHtml: true) etc.
    /// </summary>
    public string NoPerson => _item.String("NoPerson", fallback: "");
  }
}